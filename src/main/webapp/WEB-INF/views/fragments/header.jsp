...
<div class="logo">
    <a href="<c:url value='/index'/>">
        ...
        <img alt="LOGO" src="<c:url value='/static/assets/images/logo_iphones.png'/>" width="233" height="54"/>
...
<!-- ============================================================= LOGO : END ============================================================= -->     </div><!-- /.logo-holder -->
    ...
    <div class="phone inline">
        <i class="fa fa-phone"></i>  <span class="le-color">+375 29 nnn-nn-nn</span>
    </div>
    <div class="contact inline">
        <!--<i class="fa fa-envelope"></i> contact@<span class="le-color">hmccnc.com</span>-->
        <i class="fa fa-envelope"></i> <span class="le-color">nnnnnnn@gmail.com</span>
    </div>
    <div class="contact inline">
...
<!-- ============================================================= SEARCH AREA : END ============================================================= -->      </div><!-- /.top-search-holder -->
    ...
    <div class="wishlist-compare-holder">
        <div class="wishlist ">
            <a href="#"><i class="fa fa-heart"></i> Wishlist(DW!) <span class="value">${wishlistCart.numberOfItems}</span> </a>
        </div>
        <div class="compare">
            <a href="/compare"><i class="fa fa-exchange"></i>Compare<span class="compare-value"></span></a>
                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                <div class="thumb">
                                    <img alt="" src="<c:url value='/assets/images/products/${hmc.product.photo1}'/>" />
                                </div>
                            </div>
